...
glitcher.glitch('img/logo.png', function () {
  document.querySelector('.main-container').appendChild(glitcher.canvas);
});
...
setInterval(function () {
  glitcher.options = {
    ...
    lineOffset: {
      value: 5 * randomRange(0, 2),
      lineHeight: 25 * randomRange(1, 2)
    }
  };
  glitcher.process();
}, 125);